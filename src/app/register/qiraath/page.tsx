...
import QiraathRegistrationForm from "@/components/QiraathRegistrationForm";
...
export default function QiraathRegistrationPage() {
  const containerRef = useRef<HTMLDivElement>(null);
  const { forms, loading: settingsLoading } = useFormSettings();
  const formSettings = forms.find(f => f.id === "qiraath");
      ...
      <div className="relative z-10 container mx-auto pt-24 pb-12 md:pt-32 md:pb-20 px-6 max-w-7xl">
        ...
        {settingsLoading ? (
          ...
          <div className="form-container max-w-3xl mx-auto">
            <ClosingPopup formId="qiraath" />
            <QiraathRegistrationForm />
          </div>
        )}
