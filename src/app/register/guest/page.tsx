...
export default function GuestRegistrationPage() {
  ...
  const formSettings = forms.find(f => f.id === "guest");
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="bg-orb absolute top-[-5%] left-[-5%] w-[50%] h-[50%] rounded-full"
          style={{ background: "radial-gradient(circle, rgba(16,185,129,0.12) 0%, transparent 70%)", filter: "blur(100px)" }} />
        <div className="bg-orb absolute bottom-0 right-[-10%] w-[40%] h-[40%] rounded-full"
