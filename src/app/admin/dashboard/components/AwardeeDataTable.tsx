                ...
                >
                  <TableCell className="py-4 pl-6">
                    <div className="flex items-center gap-4">
                      <Avatar className="h-8 w-8 border border-slate-100 shadow-sm overflow-hidden text-violet-600">
                        {reg.photoUrl ? (
                          <AvatarImage src={reg.photoUrl} className="object-cover" />
                        ) : (
                          <AvatarFallback className="bg-violet-50">
                            <User size={16} />
                          </AvatarFallback>
                        )}
                      </Avatar>
                  ...
                  <TableCell className="py-4">
                    <div className="flex flex-col gap-0.5">
                      ...
                      <span className="text-[9px] font-medium text-slate-500 uppercase tracking-wider line-clamp-1">
                        {locations.find(z => z.name === reg.zone)?.schools.find(s => s.name === reg.school)?.name || reg.school}
                      </span>
                    </div>
                  </TableCell>
                  <TableCell className="py-4">
                  ...
                  <TableCell className="py-4">
                    <div className="flex items-center gap-1.5 text-[11px] font-normal text-slate-600 leading-tight uppercase">
                      <Award size={12} className="text-violet-500 shrink-0" />
                      {reg.selectionType}
                    </div>
                  </TableCell>
                  <TableCell className="py-4">
                  ...
                  <TableCell className="py-4 text-right pr-6">
                    <Link href={`/admin/dashboard/awardee/${reg.id}`}>
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-8 px-3 text-[10px] font-bold uppercase tracking-widest text-violet-600 hover:text-violet-700 hover:bg-violet-50 rounded-xl transition-all"
                      >
                        View Profile
                      </Button>
                    </Link>
